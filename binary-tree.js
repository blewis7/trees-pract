...
class BinaryTree {
  ...
  maxSum() {
    ...
    function maxSumHelper(node){
      ...
      result = Math.max(0, leftSum + rightSum + node.val)
  ...
  nextLarger(lowerBound) {
    ...
    while (queue.length > 0){
      ...
      let isItHigherThanLowerBound = currentVal > lowerBound;
      let isValLowerThanClosest = currentVal < closest || closest === null;

      if (isItHigherThanLowerBound && isValLowerThanClosest){
        closest = currentVal;
      }
